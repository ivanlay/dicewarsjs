...
describe('Map vs Array Comparison for AreaData', () => {
  ...
  describe('Performance', () => {
    test('Map should be more efficient for large adjacency lists', () => {
      ...
      console.log(
        `Array setup: ${arraySetupTime.toFixed(2)}ms, Map setup: ${mapSetupTime.toFixed(2)}ms`
      );
      console.log(
        `Array access: ${arrayAccessTime.toFixed(2)}ms, Map access: ${mapAccessTime.toFixed(2)}ms`
      );
      ...
      console.log(
        `Array getAdjacent: ${arrayGetTime.toFixed(2)}ms, Map getAdjacent: ${mapGetTime.toFixed(2)}ms`
      );
    ...
    test('Map should handle sparse adjacency data more efficiently', () => {
      ...
      console.log(
        `Sparse array lookup: ${arrayTime.toFixed(2)}ms, Sparse map lookup: ${mapTime.toFixed(2)}ms`
      );
